...
def run_alexa():
    ...
    try:
        ...
        if 'hello' in command:
            ...
            open different websites like insta gram, youtube,gmail, git hub, stack overflow and searches on google,Open System apps like Moicrosoft Team,Whatsapp, Calculator, Notepad, Command Prompt, How may i help you ??''')
            ...
            print('Opening Whatsapp .....')
            engine_talk('opening whatsapp..')
            subprocess.call('C:\\Users\\adars\\AppData\\Local\\WhatsApp\\WhatsApp.exe')


        elif 'open microsoft team' in command:
            print('Opening Msteams....')
            engine_talk('opening ms teams.....')
            subprocess.call('C:\\Users\\adars\\AppData\\Local\\Microsoft\\Teams\\Update.exe --processStart "Teams.exe"')
            time.sleep(1)
            ...
            subprocess.call('%windir%\\system32\\cmd.exe')
